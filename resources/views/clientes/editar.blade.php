...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            {!! Form::model($cliente, ['route' => ['cliente.atualizar', $cliente->id], 'method' => 'patch', 'files'=>true]) !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    {!! Form::text('nome', $cliente->nome, ['class' => 'form-control', 'required'=>'','maxlength'=>'50' ]) !!}
                    <small id="emailHelp" class="form-text text-muted">Tamanho máximo: 50 caracteres.</small>
                </div>

                <div class="col-md-6">
                    {!! Form::label('galc', 'Galc:', ['class' => 'control-label']) !!}
                    {!! Form::text('galc', $cliente->galc, ['class' => 'form-control', 'required'=>'','maxlength'=>'50' ]) !!}
                    <small id="emailHelp" class="form-text text-muted">Tamanho máximo: 50 caracteres.</small>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    {!! Form::text('endereco', $cliente->endereco, ['class' => 'form-control', 'required'=>'','maxlength'=>'100' ]) !!}
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    {!! Form::number('porta', $cliente->porta, ['class' => 'form-control', 'required'=>'','maxlength'=>'100' ]) !!}
                    <!-- <small id="emailHelp" class="form-text text-muted">Tamanho máximo: 100 caracteres.</small> -->
                </div>
                <div class="col-md-4">
                    {!! Form::label('velocidade', 'Velocidade:', ['class' => 'control-label']) !!}
                    {!! Form::number('velocidade', $cliente->velocidade, ['class' => 'form-control', 'required'=>'','maxlength'=>'100' ]) !!}
                    <!-- <small id="emailHelp" class="form-text text-muted">Tamanho máximo: 100 caracteres.</small> -->
                </div>

                <div class="col-md-4">
                    {!! Form::label('ativo', 'Cliente Ativo?:', ['class' => 'control-label']) !!}
                    {!! Form::select('ativo', array('1' => 'Sim', '0' => 'Não'), $cliente->ativo, ['class' => 'form-control', 'required'=>'','maxlength'=>'100' ]) !!}
                    <!-- <small id="emailHelp" class="form-text text-muted">Tamanho máximo: 100 caracteres.</small> -->
                </div>
            </div>
